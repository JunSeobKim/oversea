...
<script src="assets/js/oversea_findpw.js"></script>
...
<body style="background-image: url('assets/images/background.jpg'); background-size: 100%;">
	...
	<center>
		...
		<h2><font color="white">비밀번호 찾기</font></h2>
		<form action="user/oversea_find_passwdProc.jsp" name="form"
			method="post" margin-top="100">

			<div class="col-3" style="text-align: left; color: #000000">
			...
			<br>
			<div class="col-3">
				<input type="submit" onclick="findpw()" value="비밀번호 찾기" class="btn btn-primary btn-lg btn-block"></input>
			</div>
		</form>
	</center>
</body>
