...
<script language="javascript" type="text/javascript"
	src="assets/js/scroll.js"></script>
<script language="javascript" type="text/javascript"
	src="assets/js/oversea_newsfeed.js"></script>
...
<body>
	...
	<div class="nk-main">
		...
		<div class="nk-header-title nk-header-title-full">
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="assets/images/osaka_banner.png" style="width: 100%"
							alt="First slide">
					</div>
					<!--슬라이드1-->
					...
					<!--슬라이드2-->
					<div class="item">
						<img src="assets/images/shanghai_banner.png" style="width: 100%"
					...
					<!--슬라이드3-->
					<div class="item">
						<img src="assets/images/paris_banner.png" style="width: 100%"
			...
			<div>
				<a class="scroll-button" onclick="fnMove()"> <font color=white>NEWSFEED</font>
